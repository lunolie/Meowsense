package dev.hez.meowsense.utils.rotation.manager;

import dev.hez.meowsense.Client;
import dev.hez.meowsense.event.bus.Listener;
import dev.hez.meowsense.event.bus.annotations.EventLink;
import dev.hez.meowsense.event.impl.input.EventMovementInput;
import dev.hez.meowsense.event.impl.player.EventJump;
import dev.hez.meowsense.event.impl.player.EventSilentRotation;
import dev.hez.meowsense.event.impl.player.EventTickAI;
import dev.hez.meowsense.event.impl.player.EventYawMoveFix;
import dev.hez.meowsense.event.impl.render.EventRender3D;
import dev.hez.meowsense.module.modules.movement.MoveFix;
